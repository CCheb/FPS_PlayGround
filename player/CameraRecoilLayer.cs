...
{
    // Custom signal that will add Camera recoil. This is the main way to add camera recoil 
	[Signal] public delegate void AddCameraRecoilSignalEventHandler();

	// How much the camera should "kick". e.g. Give it a greater +X and it will rotate up
	// All of this is specified by the weapon in the WeaponResource
	...
	// currentRotation follows targetRotation. Current camera rotation which follows targetRotation. Actual/final rotation
    ...
    // over to the CameraController. RotationOffset simply gets the currentRotation value every time its is reference/called
	...
	public override void _Ready()
	{
		...
		// to the signal will be called. In this case the signal will be emitted in the Weapons Fire function
